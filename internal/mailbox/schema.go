...
CREATE TABLE IF NOT EXISTS group_messages (
  ...
  metadata_json TEXT NOT NULL DEFAULT '{}',
  FOREIGN KEY (group_id) REFERENCES groups(group_id),
  FOREIGN KEY (sender_person_id) REFERENCES persons(person_id),
  FOREIGN KEY (sender_endpoint_id) REFERENCES endpoints(endpoint_id)
);
...
CREATE TABLE IF NOT EXISTS group_message_eligibility (
  ...
  PRIMARY KEY (group_message_id, person_id),
...
CREATE INDEX IF NOT EXISTS idx_group_messages_group_created
  ON group_messages (group_id, created_at, group_message_id);

CREATE INDEX IF NOT EXISTS idx_group_message_eligibility_person_message
  ON group_message_eligibility (person_id, group_message_id);

CREATE INDEX IF NOT EXISTS idx_group_reads_person_message
  ON group_reads (person_id, group_message_id);
